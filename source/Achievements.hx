...
class Achievements
{
	public static var achievementsStuff:Array<Dynamic> = [
		...
		["Actually, I Prefer Violet", "Beat Week I on Hard with no Misses.", false],
		["The New Mona Lisa", "Beat Week SI on hard with no Misses.", true],
		[
	...
	public static var achievementsUnlocked:Array<Dynamic> = [
		...
		['weeki_nomiss', false], // 8
		['weeksi_nomiss', false], // 9
		['ur_bad', false], // 10
		['ur_good', false], // 11
